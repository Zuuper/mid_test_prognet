...
<html lang="en">
  ...
  <div class="ml-4">
    ...
    <form action="/pengangguran/update" method="post">
        {{csrf_field()}}
        <input type="hidden" name="id" value="{{ $p->id_pengangguran }}">
        <div class="form-grup">
            <label for="nama">Nama</label>
            <input type="text" class="form-control" name="nama" value="{{$p->nama}}" require="required">
        </div>
        <div class="form-grup">
            <label for="umur">umur</label>
            <input type="text" class="form-control" name="umur" value="{{$p->umur}}" required="required">
        </div>
        <div class="form-grup">
